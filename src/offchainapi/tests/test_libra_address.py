...
def test_onchain_address_only_OK():
    ...
    # assert libra_addr.get_onchain_bytes() == onchain_address_bytes
    assert libra_addr.subaddress_bytes == None
    # assert libra_addr.get_subaddress_bytes() == None
...
def test_non_none_subaddress_OK():
    ...
    # assert libra_addr.get_subaddress_bytes() == subaddr_bytes
    expected_encoded_bytes = bech32_address_encode(
        LBR,
        onchain_address_bytes,
        subaddr_bytes
